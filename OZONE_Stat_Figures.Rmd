...
FL_winter_ozone_concen_fig <- FL_winter_ozone_egrid %>%
  ggplot(aes(x = Mean_Plant_NetGenMW, y = average_month_ozone_concentration)) +
   geom_jitter() +
  scale_x_log10() +
...
#now combining the two data frames
summer_ozone_egrid_all <- merge(egrid_data_counties_all, summer_ozone_data_all, by = 'County.FIPS.Code')
...
#now combining the two data frames
winter_ozone_egrid_all <- merge(egrid_data_counties_all, winter_ozone_data_all, by = 'County.FIPS.Code')
