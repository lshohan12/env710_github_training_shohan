...
```{r}
#Winter data sets
#January (coldest month in South)
...
#by county just for fun
FL_winter_ozone_fig3 <- FL_winter_ozone_egrid %>%
  ggplot(aes(x = County, y = average_month_ozone_concentration)) +
  geom_jitter()
```
...
```{r}
#Summer data sets
#July (hottest month in the south)
